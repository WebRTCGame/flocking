...
export function interpolateColor(colorA, colorB) {
    var interpolation = -1,
...
export function pointAngle(x1, y1, x2, y2) {
    //var tempX = x2 - x1;
    //var tempY = y2 - y1;
...
export function near(x1, y1, x2, y2, length) {
    return distance(x1, y1, x2, y2) <= length;
};

export function getPointAL(x, y, angle, length) {
